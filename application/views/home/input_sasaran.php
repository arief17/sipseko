				...
				?>
					...
					<div class="modal fade" id="update-sasaran<?= $sas['id_sasaran'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								<div class="modal-header bg-success">
									<h5 class="modal-title text-white" id="exampleModalLabel"><img src="<?= base_url() ?>assets/img/icon/data.png" width="40px" alt=""> Form Update Sasaran</h5>
									</button>
								</div>
								<div class="modal-body">
